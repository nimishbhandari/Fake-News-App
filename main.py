...
Label(mainwin, text="FAKE NEWS DETECTOR", font = ("Arial", 15), pady=10).grid(row=0, column=1)
st = ScrolledText(mainwin, wrap="word", width=135, height=30,font = ("Arial", 12)); 
st.grid(row=1, column=1, pady = 10, padx = 30)
st.insert(INSERT, """Enter News here""") 

Button(mainwin, text="Predict", command=clicked,width=32).grid(row=4, column=1, sticky="EW")
